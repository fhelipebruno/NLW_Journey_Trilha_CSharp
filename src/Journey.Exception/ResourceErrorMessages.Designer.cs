...
namespace Journey.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        public static string DATA_FIM_MENOR_INICIO {
            get {
                return ResourceManager.GetString("DATA_FIM_MENOR_INICIO", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Data de início da viagem não pode ser menor que a data atual..
        /// </summary>
        public static string DATA_INICIO_INVALIDA {
            get {
                return ResourceManager.GetString("DATA_INICIO_INVALIDA", resourceCulture);
            }
        }
